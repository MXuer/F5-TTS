...
if __name__=="__main__":
    ...
    parser.add_argument('--projs',
                        default=["King-ASR-051", "King-ASR-055", "King-ASR-078", "King-ASR-085", "King-ASR-112", "King-ASR-117", "King-ASR-119", "King-ASR-175", "King-ASR-269", "King-ASR-404", "King-ASR-415"],
                        type=list,
                        help='包含的项目名称')
