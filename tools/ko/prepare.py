...
if __name__=="__main__":
    ...
    parser.add_argument('--projs',
                        default= ["King-ASR-047", "King-ASR-047-1", "King-ASR-047-2", "King-ASR-047-3", "King-ASR-047-4", "King-ASR-064", "King-ASR-137", "King-ASR-164", "King-ASR-174", "King-ASR-208", "King-ASR-388", "King-ASR-418", "King-ASR-438", "King-ASR-663", "King-ASR-675", "King-ASR-734"],
                        type=list,
                        help='包含的项目名称')
