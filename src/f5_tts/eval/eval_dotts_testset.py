...
def get_args():
    ...
    parser.add_argument("-l", "--lang", type=str, default="bo", choices=["zh", "en", "ar", "bo"])
...
def main():
    ...
    metalst = rel_path + f"/data/dotts_testset/{lang}/meta.lst"  # seed-tts testset
